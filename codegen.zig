...
const output = blk: {
    ...
    // --- Operation → body reader mapping ---
    // Used by the dispatch to deserialize the body for execute handlers.
    w.raw("export const operationBodyReader: Record<string, ((data: Uint8Array, offset: number) => any) | null> = {\n");
