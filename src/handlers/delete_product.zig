...
pub const Context = t.HandlerContext(Prefetch, t.EventType(.delete_product), t.Identity, Status);

pub fn gen_fuzz_message(prng: *PRNG, pools: fuzz_lib.IdPools) ?t.Message {
    const fuzz = @import("../fuzz.zig");
    return t.Message.init(.delete_product, fuzz.pick_or_random_id(prng, pools.product_ids), prng.int(u128) | 1, {});
}
