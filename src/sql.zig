...
pub const products = struct {
    pub const insert: [*:0]const u8 =
        "INSERT OR IGNORE INTO products (id, name, description, price_cents, inventory, version, active) VALUES (?1, ?2, ?3, ?4, ?5, ?6, ?7);";
...
pub const collections = struct {
    pub const insert: [*:0]const u8 =
        "INSERT OR IGNORE INTO collections (id, name, active) VALUES (?1, ?2, ?3);";
    pub const update: [*:0]const u8 =
...
pub const collection_members = struct {
    pub const upsert: [*:0]const u8 =
        "INSERT OR IGNORE INTO collection_members (collection_id, product_id, removed) VALUES (?1, ?2, 0)" ++
...
pub const orders = struct {
    pub const insert: [*:0]const u8 =
        "INSERT OR IGNORE INTO orders (id, total_cents, items_len, status, timeout_at) VALUES (?1, ?2, ?3, ?4, ?5);";
    pub const insert_item: [*:0]const u8 =
        "INSERT OR IGNORE INTO order_items (order_id, product_id, name, quantity, price_cents, line_total_cents) VALUES (?1, ?2, ?3, ?4, ?5, ?6);";
