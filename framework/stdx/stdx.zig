...
// --- Tiger Web domain additions ---
const tiger_web = @import("tiger_web.zig");
pub const format_u32 = tiger_web.format_u32;
pub const format_u64 = tiger_web.format_u64;
pub const parse_uuid = tiger_web.parse_uuid;
pub const write_uuid_to_buf = tiger_web.write_uuid_to_buf;
pub const BoundedList = tiger_web.BoundedList;
